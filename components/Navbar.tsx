...
//           <Link href="/" className="text-gray-700 font-medium hover:text-indigo-600 transition">
//             Home
//           </Link>
//           <Link href="/vendor" className="text-gray-700 font-medium hover:text-indigo-600 transition">
//             Vendor
//           </Link>
//           <Link href="/yarn" className="text-gray-700 font-medium hover:text-indigo-600 transition">
//             Yarn
//           </Link>
//           <Link href="/yarn-processing" className="text-gray-700 font-medium hover:text-indigo-600 transition">
//             Yarn Processing
//           </Link>
//           <Link href="/purchase-orders" className="text-gray-700 font-medium hover:text-indigo-600 transition">
//             Purchase Orders
//           </Link>
//           <Link href="/orders" className="text-gray-700 font-medium hover:text-indigo-600 transition">
//             Orders
//           </Link>
...
//             className="ml-4 px-4 py-2 rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-white font-semibold shadow-md hover:shadow-lg hover:scale-[1.03] transition transform"
//           >
//             Logout
//           </button>
//         </div>
