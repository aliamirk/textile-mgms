...
export default function YarnProcessingPage() {
  return (
    ...
    >
      <h1 className="text-4xl font-bold text-indigo-700 mb-4">Yarn Processing</h1>
      <p className="text-gray-600 text-lg max-w-2xl text-center">
        Monitor yarn dyeing, trimming, and finishing processes.  
        This page will connect to your yarnProcessingAPI functions.
      </p>
    </motion.div>
  );
}
