    ...
    try {
      ...
      rows.forEach((row, rowIndex) => {
        ...
        headers.forEach((header, idx) => {
          ...
          doc.rect(margin + idx * colWidth, currentY, colWidth, rowHeight); // border
        });
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-extrabold text-indigo-700 mb-3">Dyeing Department</h1>
      ...
      <motion.div className="w-full max-w-6xl bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/50 p-10 mb-12 hover:shadow-indigo-200 transition-shadow duration-300">
        <h2 className="text-2xl font-bold text-indigo-700 mb-8 text-center">Process Dyeing Yarn</h2>
        <form
